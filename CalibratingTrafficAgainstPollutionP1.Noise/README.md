...
Each of the vehicles on the survey can be seen as a significant localised peak of noise. This means a video of the noise could be used as proof of traffic levels.  

It was noted that the camera did not seem to auto range the audio, so the difference in the spectra readings with and without traffic would give a reasonable approximation to the actual contribution.  

![alt tag](charts/TrafficNoise.TimeSeries-17.45-2016-03-07-01.jpg) 

**What are the Frequency components of Traffic Noise?**

The chart shows the difference between noise with and without traffic at the site, taken over a long average >> 1 sec. It can be clearly seen that the vehicle noise covers a very wide range of frequencies that cover most of the Human hearing Audio Spectral band. i.e. the most damaging and intrusive frequencies to humans and those most liable to deleteriously effect the hearing of the old or  disabled (deaf).  
